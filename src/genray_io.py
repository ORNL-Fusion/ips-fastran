...
def update_state(f_state,f_eqdsk,imode='EC',jmulti=1.0,add=0):
    ...
    # j_par[:nrho/20] = j_par[nrho/20]
    # prf_e[:nrho/20] = prf_e[nrho/20]
    # prf_i[:nrho/20] = prf_i[nrho/20]
    ...
    if imode=='EC':
        ...
        # ps.load_vol_profile_m(rho_ps,pe_ps,"rho_icrf","picrf_srcs",ksrc=0,k=0)
        # ps.load_vol_profile_m(rho_ps,pi_ps,"rho_icrf","picrf_srcs",ksrc=0,k=1)
