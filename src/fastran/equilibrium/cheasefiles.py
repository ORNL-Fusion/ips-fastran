...
from fastran.equilibrium import cheaseprofit
...
def read_efit_file(fpath,setParam={}):
   #Developed by Ehab Hassan on 2019-02-27
    ...
    eqdskdata['ZR1D'] += eqdskdata['ZMID']-eqdskdata['ZLEN']/2.0
    ...
    eqdskdata['jtot'] = eqdskdata['RR1D']*eqdskdata['pprime']+eqdskdata['ffprime']/eqdskdata['RR1D']
    eqdskdata['jtot'][0] = 0.0025*eqdskdata['pprime'][0]+eqdskdata['ffprime'][0]/0.0025
...
def write_expeq(setParam={},**kwargs):
    ...
    if   geometry in [7,'imported'] and 'imported' in locals():
         ...
         if   'rbound' in imported and 'zbound' in imported:
              ...
              expeq['rbound']  = npy.array(imported['rbound'][:])/expeq['R0EXP']
              expeq['zbound']  = npy.array(imported['zbound'][:])/expeq['R0EXP']
         ...
         else:                      expeq['zgeom']  = expeqdata['zgeom']
         if   'aspect' in imported: expeq['aspect'] = imported['aspect']
         elif 'aspect' in setParam: expeq['aspect'] = setParam['aspect']
         else:                      expeq['aspect'] = expeqdata['aspect']
    ...
    if   nppfun[1] in [0,'chease'] and cheaseflag:
         ...
         if 'pedge' in importeddata:
            expeq['pedge'] = mu0*importeddata['pedge']/expeq['B0EXP']**2
...
def get_plasmastate(instatefpath="",statefpath="",bcfpath="",eqfpath='',setParam={}):
    ...
    if instatefpath:
        ...
        if instate['ne']:
            ...
            statedata['ne']     = cheaseprofit.fastran_fit(rho        = statedata['rho'],
        ...
        if instate['Te']:
            ...
            statedata['Te']     = cheaseprofit.fastran_fit(rho        = statedata['rho'],
        ...
        if instate['Ti']:
            ...
            statedata['Ti']     = cheaseprofit.fastran_fit(rho        = statedata['rho'],
        ...
        if instate['ni']:
            ...
            statedata['ni']     = cheaseprofit.fastran_fit(rho        = statedata['rho'],
        ...
        if instate['nz']:
            ...
            statedata['nz']     = cheaseprofit.fastran_fit(rho        = statedata['rho'],
